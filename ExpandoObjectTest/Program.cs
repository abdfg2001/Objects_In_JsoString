...
var JsonString = "[{\"Name\":\"John Doe\",\"Age\":30,\"IsEmployed\":true,\"Skills\":[\"C#\",\"JavaScript\",\"Python\"]},{\"Name\": \"Adrian\", \"Gen\": \"Male\", \"Height\": 12}]";
var JsonAlong = "{\"Name\":\"Santa Claus\",\"Age\":120,\"IsEmployed\":true,\"Skills\":[\"Gift\",\"Toys\",\"Merry Christmas\"]}";



IPeople Personas = CompararUno.Comparar1<Person>(JsonAlong);

Console.WriteLine("*************compare between an object and an object in a json string list*************");

var properties1 = Personas.GetType().GetProperties(BindingFlags.Public | BindingFlags.Instance);
...
List<IPeople> people = CompararUno.Comparar<PersonGen>(JsonString);
